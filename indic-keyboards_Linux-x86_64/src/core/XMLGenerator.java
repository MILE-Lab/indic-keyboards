...
public class XMLGenerator extends org.eclipse.swt.widgets.Composite {
	...
	private void initGUI() {
		try {
			...
			this.setSize(714, 434);
			{
				...
				label1
						.setText("Replace each of these characters with their\ncorresponding Unicodes and press OK");
				...
				label1.setFont(SWTResourceManager.getFont("Tahoma", 16, 0,
						false, false));
				label1.setAlignment(SWT.CENTER);
				label1
						.setBackground(SWTResourceManager.getColor(117, 117,
								221));
			}
	...
	private void buttonOKMouseDown(MouseEvent evt) {
		...
		dialog.setFilterNames(new String[] { "XML Documents" });
		dialog.setFilterExtensions(new String[] { "*.xml" }); // Wild
		// cards
		...
		try {
			...
			/*
			 * now the convert method will simply convert and the o/p is put to
			 * file only after the user presses ok button
			 */
			// Write header
			...
			if (a.getText().compareTo("a") == 0 || a.getText().compareTo("")==0) {
			...
			if (s.getText().compareTo("s") == 0 || s.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (d.getText().compareTo("d") == 0 || d.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (f.getText().compareTo("f") == 0 || f.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (g.getText().compareTo("g") == 0|| g.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (h.getText().compareTo("h") == 0|| h.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (j.getText().compareTo("j") == 0|| j.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (k.getText().compareTo("k") == 0|| k.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (l.getText().compareTo("l") == 0|| l.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (q.getText().compareTo("q") == 0|| q.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (w.getText().compareTo("w") == 0|| w.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (e.getText().compareTo("e") == 0|| e.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (r.getText().compareTo("r") == 0|| r.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (t.getText().compareTo("t") == 0|| t.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (y.getText().compareTo("y") == 0|| y.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (u.getText().compareTo("u") == 0|| u.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (i.getText().compareTo("i") == 0|| i.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (o.getText().compareTo("o") == 0|| o.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (p.getText().compareTo("p") == 0|| p.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (z.getText().compareTo("z") == 0|| z.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (x.getText().compareTo("x") == 0|| x.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (c.getText().compareTo("c") == 0|| c.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (v.getText().compareTo("v") == 0|| v.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (b.getText().compareTo("b") == 0|| b.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (n.getText().compareTo("n") == 0|| n.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (m.getText().compareTo("m") == 0|| m.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (zero.getText().compareTo("0") == 0|| zero.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (one.getText().compareTo("1") == 0||one.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (exclaim.getText().compareTo("!") == 0|| exclaim.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (two.getText().compareTo("2") == 0|| two.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (AT.getText().compareTo("@") == 0|| AT.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "@" + "</char>");
			...
			if (three.getText().compareTo("3") == 0|| three.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (hash.getText().compareTo("#") == 0|| hash.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "#" + "</char>");
			...
			if (four.getText().compareTo("4") == 0|| four.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (dollar.getText().compareTo("$") == 0|| dollar.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "$" + "</char>");
			...
			if (five.getText().compareTo("5") == 0|| five.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (percent.getText().compareTo("%") == 0|| percent.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "%" + "</char>");
			...
			if (six.getText().compareTo("6") == 0|| six.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (cap.getText().compareTo("^") == 0|| cap.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "^" + "</char>");
			...
			if (seven.getText().compareTo("7") == 0|| seven.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (ampersand.getText().compareTo("&") == 0|| ampersand.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "&amp;" + "</char>");
				newXML
						.println("<unicode>" + ampersand.getText()
								+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (eight.getText().compareTo("8") == 0|| eight.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (asteriks.getText().compareTo("*") == 0|| asteriks.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "*" + "</char>");
			...
			if (nine.getText().compareTo("9") == 0|| nine.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
			...
			if (leftBracket.getText().compareTo("(") == 0|| leftBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "(" + "</char>");
				newXML.println("<unicode>" + leftBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}
			...
			if (rightBracket.getText().compareTo(")") == 0|| rightBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + ")" + "</char>");
				newXML.println("<unicode>" + rightBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}
			...
			if (hyphen.getText().compareTo("-") == 0|| hyphen.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "-" + "</char>");
			...
			if (underScore.getText().compareTo("_") == 0|| underScore.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "_" + "</char>");
				newXML.println("<unicode>" + underScore.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (equals.getText().compareTo("=") == 0|| equals.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "=" + "</char>");
			...
			if (backSlash.getText().compareTo("\\") == 0|| backSlash.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "\\" + "</char>");
				newXML
						.println("<unicode>" + backSlash.getText()
								+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (pipe.getText().compareTo("|") == 0|| pipe.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "|" + "</char>");
			...
			if (leftArrayBracket.getText().compareTo("[") == 0|| leftArrayBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "[" + "</char>");
				newXML.println("<unicode>" + leftArrayBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (rightArrayBracket.getText().compareTo("]") == 0|| rightArrayBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "]" + "</char>");
				newXML.println("<unicode>" + rightArrayBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (leftBrace.getText().compareTo("{") == 0|| leftBrace.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "{" + "</char>");
				newXML
						.println("<unicode>" + leftBrace.getText()
								+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (rightBrace.getText().compareTo("}") == 0|| rightBrace.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "}" + "</char>");
				newXML.println("<unicode>" + rightBrace.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (semiColon.getText().compareTo(";") == 0|| semiColon.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + ";" + "</char>");
				newXML
						.println("<unicode>" + semiColon.getText()
								+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (colon.getText().compareTo(":") == 0|| colon.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + ":" + "</char>");
			...
			if (doubleQuote.getText().compareTo("\"") == 0|| doubleQuote.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "\"" + "</char>");
				newXML.println("<unicode>" + doubleQuote.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (singleQuote.getText().compareTo("'") == 0|| singleQuote.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "'" + "</char>");
				newXML.println("<unicode>" + singleQuote.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (comma.getText().compareTo(",") == 0|| comma.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "," + "</char>");
			...
			if (fullStop.getText().compareTo(".") == 0|| fullStop.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "." + "</char>");
			...
			if (leftAngularBracket.getText().compareTo("<") == 0|| leftAngularBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "&lt;" + "</char>");
				newXML.println("<unicode>" + leftAngularBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (rightAngularBracket.getText().compareTo(">") == 0|| rightAngularBracket.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "&gt;" + "</char>");
				newXML.println("<unicode>" + rightAngularBracket.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (questionMark.getText().compareTo("?") == 0|| questionMark.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "?" + "</char>");
				newXML.println("<unicode>" + questionMark.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (frontSlash.getText().compareTo("/") == 0|| frontSlash.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "/" + "</char>");
				newXML.println("<unicode>" + frontSlash.getText()
						+ "</unicode>");
				newXML.println("</pattern>\n");
			}

			if (tilde.getText().compareTo("~") == 0|| tilde.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "~" + "</char>");
			...
			if (backTick.getText().compareTo("`") == 0|| backTick.getText().compareTo("")==0) {
				// don't add to the XML file
			} else {
				newXML.println("<pattern>");
				newXML.println("<char>" + "`" + "</char>");
			...
			Logger.getLogger(XMLGenerator.class.getName()).log(Level.SEVERE,
					null, ex);
